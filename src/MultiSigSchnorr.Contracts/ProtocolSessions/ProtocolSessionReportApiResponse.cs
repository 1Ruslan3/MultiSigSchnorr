...
public sealed class ProtocolSessionReportApiResponse
{
    ...
    public IReadOnlyList<ProtocolSessionReportParticipantApiResponse> Participants { get; init; }
        = Array.Empty<ProtocolSessionReportParticipantApiResponse>();
}

public sealed class ProtocolSessionReportParticipantApiResponse
{
